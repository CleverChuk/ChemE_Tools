...
% Last Modified by GUIDE v2.5 19-Feb-2016 18:08:51
...
[Z, H, S, U, phi, info] = evalin('base','PreosProps(Tref, Pref, T, P, match,propsRow)');
...
function Cname_Callback(hObject, eventdata, handles)
% hObject    handle to Cname (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of Cname as text
%        str2double(get(hObject,'String')) returns contents of Cname as a double
handles.Ename = get(hObject,'String');
guidata(hObject,handles)



% --- Executes during object creation, after setting all properties.
function Cname_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Cname (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% handles    structure with handles and user data (see GUIDATA)
Ename = handles.Ename;
set(handles.name,'String',upper(Ename));
[num] = queryFunc(Ename);
assignin('base','propsRow',num)
